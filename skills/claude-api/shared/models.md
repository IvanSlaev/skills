...
| Claude Opus 5.5 | `claude-opus-5-5` | -                             | 1M             | 128K       | Active (launching; use only when the user names it) |
...
| "opus 5.5"                                | `claude-opus-5-5` (launching - see migration guide) |
